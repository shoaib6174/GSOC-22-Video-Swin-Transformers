...
Fine-tunable Video Swin Transformer model pre-trained on the Kinetics 600(1k) dataset and was then fine-tuned on ImageNet-22K dataset.
...
## Overview
This model is a Video Swin Transformer [1] pre-trained on the Kinetics 600(1k) dataset and was then fine-tuned on ImageNet-22K dataset. You can find the complete
