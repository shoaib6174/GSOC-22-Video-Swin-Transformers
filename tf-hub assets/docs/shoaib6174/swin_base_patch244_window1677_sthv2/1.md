...
Fine-tunable Video Swin Transformer model pre-trained on the Something-Something V2 dataset and was then fine-tuned on Kinetics 400 dataset.
...
## Overview
This model is a Video Swin Transformer [1] pre-trained on the Something-Something V2 dataset and was then fine-tuned on Kinetics 400 dataset. You can find the complete
