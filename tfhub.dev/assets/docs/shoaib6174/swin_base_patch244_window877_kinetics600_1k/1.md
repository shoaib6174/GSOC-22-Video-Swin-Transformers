# Module shoaib6174/swin_base_patch244_window877_kinetics600_1k/1
...
<!-- asset-path: https://gsoc4108768259.blob.core.windows.net/azureml-blobstore-cf8fa289-ef6f-4db3-b097-1d65257e5a14/swin_base_patch244_window877_kinetics600_1k_tf.tar.gz -->
...
## Overview
This model is a Video Swin Transformer [1] pre-trained on the ImageNet-22K dataset and was then fine-tuned on Kinetics 600(1k) dataset. You can find the complete
...
model = hub.load("https://tfhub.dev/shoaib6174/swin_base_patch244_window877_kinetics600_1k/1")
