...
## Overview
This model is a Video Swin Transformer [1] feature extractor model pre-trained on the $PRE_TRAIN_DATASET dataset and was then fine-tuned on $FINE_TUNE_DATASET dataset. You can find the complete
